! function(_) {
    ...
    var e, t, n, i, r, o = tinymce.util.Tools.resolve("tinymce.ThemeManager"),
            ...
            var i, o = function() {
                ...
                n = function(e, t) {
                    ...
                    if (!x.removed) {
                        ...
                        x.inline || (o.w = x.getDoc().documentElement.offsetWidth), x.selection.controlSelection.isResizable(e.element) && r.w < 25 && (r = E.inflate(r, 0, 8)), n = E.findBestRelativePosition(i, r, o, l), r = E.clamp(r, o), n ? (a = E.relativePosition(i, r, n), U(s, V(u, a.x, a.y, r, o, i))) : (o.h += i.h, (r = E.intersect(o, r)) ? (n = E.findBestRelativePosition(i, r, o, ["bc-tc", "bl-tl", "br-tr"])) ? (a = E.relativePosition(i, r, n), U(s, V(u, a.x, a.y, r, o, i))) : U(s, V(u, r.x, r.y, r, o, i)) : s.hide()), g = s, v = function(e, t) {
                            return e === t
        ...
        X = $("function"),
        j = $("number"),
        J = (Array.prototype.slice, (r = Array.prototype.indexOf) === undefined ? function(e, t) {
            return te(e, t)
        } : function(e, t) {
            return r.call(e, t)
        }),
        G = function(e, t) {
            return ee(e, t).isSome()
        },
        K = function(e, t) {
        ...
        se = function(n, e, t, i) {
            ...
            return e ? (o = e[i], a = !0) : o = ie[i], o && (r = {
                ...
                var n;
                e.context !== i || (n = t, ee(s, function(e) {
                    return e.name === n
                ...
                }), e.prependToContext ? s.unshift(re(t, e)) : s.push(re(t, e)), "after" === e.separator && s.push({
                    name: "|",
                    item: {
                        text: "|"
                    }
                }))
            }), r.menu = K((l = t, u = Q(s, function(e) {
                return !1 === l.hasOwnProperty(e.name)
            }), c = Q(u, function(e, t, n) {
                return !oe(e) || !oe(n[t - 1])
            }), Q(c, function(e, t, n) {
                return !oe(e) || 0 < t && t < n.length - 1
            })), function(e) {
                return e.item
        ...
        ge = function(c, d, f) {
            return function(e) {
                ...
                i = d, r = a, o = f, w.each(o, function(e) {
                    ...
                    t && t.visible() && e.name !== i && (me(e, t, "onhide"), t.visible(!1))
                }), s.parent().items().each(function(e) {
                    e.active(!1)
                }), l && l.visible() ? (me(u, l, "onhide"), l.hide(), s.active(!1)) : (l ? l.show() : (l = b.create({
                    type: "container",
                    name: d,
                    layout: "stack",
                    classes: "sidebar-panel",
                    html: ""
                }), a.prepend(l), me(u, l, "onrender")), me(u, l, "onshow"), s.active(!0)), x(c)
            }
        },
        pe = function(e) {
            return !(he.ie && !(11 <= he.ie) || !e.sidebars) && 0 < e.sidebars.length
        },
        ve = function(n) {
            return {
                type: "panel",
                ...
                items: [{
                    ...
                    items: w.map(n.sidebars, function(e) {
                        ...
                        return {
                            ...
                            image: t.image,
                            tooltip: t.tooltip,
                            onclick: ge(n, e.name, n.sidebars)
                        }
                    })
                }]
            }
        ...
        we = function(t, e, n) {
            var i, r, o, s, a;
            if (!1 === g(t) && n.skinUiCss ? ye.styleSheetLoader.load(n.skinUiCss, be(t)) : be(t)(), i = e.panel = b.create({
                    type: "panel",
                    role: "application",
                    classes: "tinymce",
                ...
                }), A.setUiContainer(t, i), "none" !== p(t) && (r = {
                    type: "resizehandle",
                    direction: p(t),
                    ...
                    onResize: function(e) {
                        "both" === p(t) ? de(t, o.width + e.deltaX, o.height + e.deltaY) : de(t, null, o.height + e.deltaY)
                    }
                }), t.getParam("statusbar", !0, "boolean")) {
                var l = y.translate(["Powered by {0}", '<a href="https://www.tiny.cloud/?utm_campaign=editor_referral&amp;utm_medium=poweredby&amp;utm_source=tinymce" rel="noopener" target="_blank" role="presentation" tabindex="-1">Tiny</a>']),
            ...
            return R(t), t.on("SwitchMode", (a = i, function(e) {
                a.find("*").disabled("readonly" === e.mode)
            })), i.renderBefore(n.targetNode).reflow(), t.getParam("readonly", !1, "boolean") && t.setMode("readonly"), n.width && ye.setStyle(i.getEl(), "width", n.width), t.on("remove", function() {
                i.remove(), i = null
            }), C(t, i), Y(t), {
        ...
        _e = tinymce.util.Tools.resolve("tinymce.dom.DomQuery"),
        Re = 0,
        Ce = {
            id: function() {
                return "mceu_" + Re++
            ...
            getContainer: function() {
                return he.container ? he.container : _.document.body
            },
    ...
    var Se = function() {
        ...
        Me = {
            ...
            moveTo: function(e, t) {
                ...
                return s && Ee(s) && !ke(n) && (e -= s.scrollLeft, t -= s.scrollTop), s && (e += 1, t += 1), n.state.get("rendered") ? n.layoutRect({
                    x: e,
                    y: t
        ...
        Pe = tinymce.util.Tools.resolve("tinymce.util.EventDispatcher"),
        We = function(e) {
            var t;
    ...
    function Ae(e) {
        this.cls = [], this.cls._map = {}, this.onchange = e || Oe, this.prefix = ""
    }
        ...
        Ve = Ne.extend({
            init: function(e) {
                ...
                function s(e, t, n) {
                    ...
                    }((i = Ie.exec(e.replace(Ue, "")))[1])), r(function(t) {
                ...
                function a(e, t) {
                    var n, i, r, o = [];
                    do {
                        if (Fe.exec(""), (i = Fe.exec(e)) && (e = i[3], o.push(i[1]), i[2])) {
                            n = i[3];
                            break
                        }
                    } while (i);
            ...
            find: function(e) {
                ...
                return Be || (Be = Ve.Collection), new Be(u)
            }
        }),
    ...
    ze = {
        ...
        add: function(e) {
            return w.isArray(e) ? Ye.apply(this, e) : e instanceof Le ? this.add(e.toArray()) : Ye.call(this, e), this
        },
        set: function(e) {
            var t, n = this,
                i = n.length;
        ...
        filter: function(t) {
            var e, n, i, r, o = [];
            for ("string" == typeof t ? (t = new Ve(t), r = function(e) {
                    return t.match(e)
                }) : r = t, e = 0, n = this.length; e < n; e++) r(i = this[e]) && o.push(i);
            return new Le(o)
        },
        slice: function() {
            return new Le($e.apply(this, arguments))
        },
        eq: function(e) {
        ...
        et = {
            add: function(e) {
                ...
                if (t) {
                    ...
                    Qe[t._id] || (Qe[t._id] = t), Ge || (Ge = !0, u.requestAnimationFrame(function() {
                        var e, t;
                        for (e in Ge = !1, Qe)(t = Qe[e]).state.get("rendered") && t.reflow();
                        Qe = {}
                    }, _.document.body))
                }
            },
            remove: function(e) {
                Qe[e._id] && delete Qe[e._id]
            }
        },
        tt = "onmousewheel" in _.document,
        nt = !1,
        it = 0,
        rt = {
            Statics: {
            ...
            init: function(t) {
                ...
                i.settings = t = w.extend({}, i.Defaults, t), i._id = t.id || "mceu_" + it++, i._aria = {
                    role: t.role
                }, i._elmCache = {}, i.$ = _e, i.state = new Ze({
                    visible: !0,
                    active: !1,
                    disabled: !1,
                    value: ""
                }), i.data = new Ze(t.data), i.classes = new Ae(function() {
                ...
                }), i.settings = t, i.borderBox = We(t.border), i.paddingBox = We(t.padding), i.marginBox = We(t.margin), t.hidden && i.hide()
            },
            ...
            layoutRect: function(e) {
                var t, n, i, r, o, s = this,
                    a = s._layoutRect;
                return a || (a = s.initLayoutRect()), e ? (i = a.deltaW, r = a.deltaH, e.x !== undefined && (a.x = e.x), e.y !== undefined && (a.y = e.y), e.minW !== undefined && (a.minW = e.minW), e.minH !== undefined && (a.minH = e.minH), (n = e.w) !== undefined && (n = (n = n < a.minW ? a.minW : n) > a.maxW ? a.maxW : n, a.w = n, a.innerW = n - i), (n = e.h) !== undefined && (n = (n = n < a.minH ? a.minH : n) > a.maxH ? a.maxH : n, a.h = n, a.innerH = n - r), (n = e.innerW) !== undefined && (n = (n = n < a.minW - i ? a.minW - i : n) > a.maxW - i ? a.maxW - i : n, a.innerW = n, a.w = n + i), (n = e.innerH) !== undefined && (n = (n = n < a.minH - r ? a.minH - r : n) > a.maxH - r ? a.maxH - r : n, a.innerH = n, a.h = n + r), e.contentW !== undefined && (a.contentW = e.contentW), e.contentH !== undefined && (a.contentH = e.contentH), (t = s._lastLayoutRect).x === a.x && t.y === a.y && t.w === a.w && t.h === a.h || ((o = Ke.repaintControls) && o.map && !o.map[s._id] && (o.push(s), o.map[s._id] = !0), t.x = a.x, t.y = a.y, t.w = a.w, t.h = a.h), s) : a
            },
            repaint: function() {
                var e, t, n, i, r, o, s, a, l, u, c = this;
            ...
            on: function(e, t) {
                var n, i, r, o = this;
                return ot(o).on(e, "string" != typeof(n = t) ? n : function(e) {
            ...
            off: function(e, t) {
                return ot(this).off(e, t), this
            },
            fire: function(e, t, n) {
                if ((t = t || {}).control || (t.control = this), t = ot(this).fire(e, t), !1 !== n && this.parent)
                    for (var i = this.parent(); i && !t.isPropagationStopped();) i.fire(e, t, !1), i = i.parent();
                return t
            },
            hasEventListeners: function(e) {
                return ot(this).has(e)
            },
            parents: function(e) {
                var t, n = new qe;
            ...
            parentsAndSelf: function(e) {
                return new qe(this).add(this.parents(e))
            },
            next: function() {
            ...
            getEl: function(e) {
                ...
                return this._elmCache[t] || (this._elmCache[t] = _e("#" + t)[0]), this._elmCache[t]
            },
            show: function() {
            ...
            remove: function() {
                ...
                r && r.items && (t = [], r.items().each(function(e) {
                    e !== n && t.push(e)
                }), r.items().set(t), r._lastRect = null), n._eventsRoot && n._eventsRoot === n && _e(i).off();
            ...
            renderBefore: function(e) {
                return _e(e).before(this.renderHtml()), this.postRender(), this
            },
            renderTo: function(e) {
                return _e(e || this.getContainerElm()).append(this.renderHtml()), this.postRender(), this
            },
            preRender: function() {},
            render: function() {},
            renderHtml: function() {
            ...
            postRender: function() {
                var e, t, n, i, r, o = this,
                    s = o.settings;
                for (i in o.$el = _e(o.getEl()), o.state.set("rendered", !0), s) 0 === i.indexOf("on") && o.on(i.substr(2), s[i]);
                if (o._eventsRoot) {
                    for (n = o.parent(); !r && n; n = n.parent()) r = n._eventsRoot;
                    if (r)
                        for (i in r._nativeEvents) o._nativeEvents[i] = !0
                }
                st(o), s.style && (e = o.getEl()) && (e.setAttribute("style", s.style), e.style.cssText = s.style), o.settings.border && (t = o.borderBox, o.$el.css({
                ...
                !1 === o.state.get("visible") && (o.getEl().style.display = "none"), o.bindStates(), o.state.on("change:visible", function(e) {
                    var t, n = e.value;
                    o.state.get("rendered") && (o.getEl().style.display = !1 === n ? "none" : "", o.getEl().getBoundingClientRect()), (t = o.parent()) && (t._lastRect = null), o.fire(n ? "show" : "hide"), et.add(o)
                }), o.fire("postrender", {}, !1)
            },
            bindStates: function() {},
    ...
    function ot(n) {
        return n._eventDispatcher || (n._eventDispatcher = new Pe({
            scope: n,
            toggleEvent: function(e, t) {
                t && Pe.isNative(e) && (n._nativeEvents || (n._nativeEvents = {}), n._nativeEvents[e] = !0, n.state.get("rendered") && st(n))
            }
        })), n._eventDispatcher
    }
    ...
    function st(a) {
        ...
        if (i = a._nativeEvents) {
            ...
            for (r in d || (d = l._delegates = {}), i) {
                if (!i) return !1;
                "wheel" !== r || nt ? ("mouseenter" === r || "mouseleave" === r ? l._hasMouseEnter || (_e(l.getEl()).on("mouseleave", s).on("mouseover", u), l._hasMouseEnter = 1) : d[r] || (_e(l.getEl()).on(r, o), d[r] = !0), i[r] = !1) : tt ? _e(a.getEl()).on("mousewheel", c) : _e(a.getEl()).on("DOMMouseScroll", c)
            }
        }
    }
    ...
    function ut(e) {
        ...
        function c(t) {
            ...
            return function e(t) {
                if (1 === t.nodeType && "none" !== t.style.display && !t.disabled) {
                    var n;
                    (u(n = t) && !n.hidden || lt(n) || /^(button|menuitem|checkbox|tab|menuitemcheckbox|option|gridcell|slider)$/.test(s(n))) && r.push(t);
        ...
        return r = n.getParentCtrl(o), n.on("keydown", function(e) {
            function t(e, t) {
                u(o) || lt(o) || "slider" !== s(o) && !1 !== t(e) && e.preventDefault()
            }
    ...
    var ct = {},
        dt = at.extend({
            init: function(e) {
                var t = this;
                t._super(e), (e = t.settings).fixed && t.state.set("fixed", !0), t._items = new qe, t.isRtl() && t.classes.add("rtl"), t.bodyClasses = new Ae(function() {
            ...
            find: function(e) {
                return (e = ct[e] = ct[e] || new Ve(e)).find(this)
            },
            add: function(e) {
            ...
            create: function(e) {
                ...
                return w.isArray(e) || (e = [e]), w.each(e, function(e) {
                    e && (e instanceof at || ("string" == typeof e && (e = {
                        type: e
            ...
            renderNew: function() {
                ...
                return i.items().each(function(e, t) {
                    var n;
                    e.parent(i), e.state.get("rendered") || ((n = i.getEl("body")).hasChildNodes() && t <= n.childNodes.length - 1 ? _e(n.childNodes[t]).before(e.renderHtml()) : _e(n).append(e.renderHtml()), e.postRender(), et.add(e))
            ...
            reflow: function() {
                var e;
                if (et.remove(this), this.visible()) {
                    for (at.repaintControls = [], at.repaintControls.map = {}, this.recalc(), e = at.repaintControls.length; e--;) at.repaintControls[e].repaint();
                    "flow" !== this.settings.layout && "stack" !== this.settings.layout && this.repaint(), at.repaintControls = []
                }
                return this
            }
        });
    ...
    function ht(e, h) {
        var m, g, t, p, v, b, y, x = h.document || _.document;
        h = h || {};
        ...
        t = function(e) {
            ...
            ft(e), e.preventDefault(), g = e.button, c = w, b = e.screenX, y = e.screenY, d = _.window.getComputedStyle ? _.window.getComputedStyle(c, null).getPropertyValue("cursor") : c.runtimeStyle.cursor, m = _e("<div></div>").css({
                position: "absolute",
                top: 0,
                left: 0,
                width: f.width,
                ...
                opacity: 1e-4,
                cursor: d
            }).appendTo(x.body), _e(x).on("mousemove touchmove", v).on("mouseup touchend", p), h.start(e)
        }, v = function(e) {
            if (ft(e), e.button !== g) return p(e);
            e.deltaX = e.screenX - b, e.deltaY = e.screenY - y, e.preventDefault(), h.drag(e)
        }, p = function(e) {
            ft(e), _e(x).off("mousemove touchmove", v).off("mouseup touchend", p), m.remove(), h.stop && h.stop(e)
        }, this.destroy = function() {
            _e(w).off()
        }, _e(w).on("mousedown touchstart", t)
    }
    var mt, gt, pt, vt, bt = {
            init: function() {
                ...
                function n() {
                    ...
                    function t(e, t, n, i, r, o) {
                        ...
                        if (a = p.getEl("scroll" + e)) {
                            if (f = t.toLowerCase(), h = n.toLowerCase(), _e(p.getEl("absend")).css(f, p.layoutRect()[i] - 1), !r) return void _e(a).css("display", "none");
                            _e(a).css("display", "block"), s = p.getEl("body"), l = p.getEl("scroll" + e + "t"), u = s["client" + n] - 2 * v, c = (u -= m && g ? a["client" + o] : 0) / s["scroll" + n], (d = {})[f] = s["offset" + t] + v, d[h] = u, _e(a).css(d), (d = {})[f] = s["scroll" + t] * c, d[h] = u * c, _e(l).css(d)
                        }
                    }
                ...
                p.settings.autoScroll && (p._hasScroll || (p._hasScroll = !0, function() {
                    function e(s, a, l, u, c) {
                        var d, e = p._id + "-scroll" + s,
                            t = p.classPrefix;
                        _e(p.getEl()).append('<div id="' + e + '" class="' + t + "scrollbar " + t + "scrollbar-" + s + '"><div id="' + e + 't" class="' + t + 'scrollbar-thumb"></div></div>'), p.draghelper = new ht(e + "t", {
                            start: function() {
                                d = p.getEl("body")["scroll" + a], _e("#" + e).addClass(t + "active")
                            },
                            drag: function(e) {
    ...
    function Ct() {
            ...
            2 !== e.button && function(e) {
                for (var t = wt.length; t--;) {
                    ...
                    if (n.settings.autohide) {
                        if (i && (Rt(i, n) || n.parent() === i)) continue;
                        (e = n.fire("autohide", {
                            target: e.target
        ...
        }, _e(_.document).on("click touchstart", mt))
    }
    ...
    function Et(r) {
        ...
        function t(e, t) {
            for (var n, i = 0; i < wt.length; i++)
                if (wt[i] !== r)
                    for (n = wt[i].parent(); n && (n = n.parent());) n === r && wt[i].fixed(e).moveBy(0, t).repaint()
        }
    ...
    function kt(e, t) {
        var n, i, r = Ht.zIndex || 65535;
        if (e) _t.push(t);
        else
            for (n = _t.length; n--;) _t[n] === t && _t.splice(n, 1);
        if (_t.length)
            for (n = 0; n < _t.length; n++) _t[n].modal && (r++, i = _t[n]), _t[n].getEl().style.zIndex = r, _t[n].zIndex = r, r++;
        var o = _e("#" + t.classPrefix + "modal-block", t.getContainerElm())[0];
        i ? _e(o).css("z-index", i.zIndex - 1) : o && (o.parentNode.removeChild(o), vt = !1), Ht.currentZIndex = r
    }
    var Ht = yt.extend({
        Mixins: [Me, xt],
        init: function(e) {
            ...
            i._super(e), (i._eventsRoot = i).classes.add("floatpanel"), e.autohide && (Ct(), function() {
                if (!pt) {
                    var e = _.document.documentElement,
                        ...
                        n = e.clientHeight;
                    pt = function() {
                        _.document.all && t === e.clientWidth && n === e.clientHeight || (t = e.clientWidth, n = e.clientHeight, Ht.hideAll())
                    }, _e(_.window).on("resize", pt)
                }
            }(), wt.push(i)), e.autofix && (gt || (gt = function() {
                var e;
                for (e = wt.length; e--;) Et(wt[e])
            }, _e(_.window).on("scroll", gt)), i.on("move", function() {
                Et(this)
            })), i.on("postrender show", function(e) {
                if (e.control === i) {
                    var t, n = i.classPrefix;
                    i.modal && !vt && ((t = _e("#" + n + "modal-block", i.getContainerElm()))[0] || (t = _e('<div id="' + n + 'modal-block" class="' + n + "reset " + n + 'fade"></div>').appendTo(i.getContainerElm())), u.setTimeout(function() {
                        t.addClass(n + "in"), _e(i.getEl()).addClass(n + "in")
                    }), vt = !0), kt(!0, i)
                }
            }), i.on("show", function() {
        ...
        show: function() {
            var e, t = this._super();
            for (e = wt.length; e-- && wt[e] !== this;);
            return -1 === e && wt.push(this), t
        },
        hide: function() {
            return St(this), kt(!1, this), this._super()
        },
        hideAll: function() {
            Ht.hideAll()
        },
        close: function() {
            return this.fire("close").isDefaultPrevented() || (this.remove(), kt(!1, this)), this
        },
        remove: function() {
            St(this), this._super()
        },
    ...
    Ht.hideAll = function() {
        for (var e = wt.length; e--;) {
            var t = wt[e];
            t && t.settings.autohide && (t.hide(), wt.splice(e, 1))
        }
    };
    var Tt = function(s, n, e) {
        var a, i, l = v.DOM,
        ...
        var r = function() {
            ...
            u = function() {
                a && (a.hide(), Ht.hideAll(), l.removeClass(s.getBody(), "mce-edit-focus"))
            },
            c = function() {
                var e, t;
                a ? a.visible() || o() : (a = n.panel = b.create({
                ...
                }), A.setUiContainer(s, a), R(s), i ? a.renderTo(i).reflow() : a.renderTo().reflow(), C(s, a), o(), Y(s), s.on("nodeChange", r), s.on("ResizeWindow", r), s.on("activate", o), s.on("deactivate", u), s.nodeChanged())
            };
        return s.settings.content_editable = !0, s.on("focus", function() {
            ...
            a && (a.remove(), a = null)
        }), !1 === g(s) && e.skinUiCss ? l.styleSheetLoader.load(e.skinUiCss, be(s)) : be(s)(), {}
    };
    ...
    function Mt(i, r) {
        ...
        a.show = function(e, t) {
            function n() {
                o && (_e(i).append('<div class="' + l + "throbber" + (r ? " " + l + "throbber-inline" : "") + '"></div>'), t && t())
            }
    ...
    var Nt = function(e, t) {
        ...
        Pt = function(e, t, n) {
            ...
            return i && (n.skinUiCss = i + "/skin.min.css", e.contentCSS.push(i + "/content" + (e.inline ? ".inline" : "") + ".min.css")), Nt(e, t), e.getParam("inline", !1, "boolean") ? Tt(e, t, n) : we(e, t, n)
        },
        Wt = at.extend({
            Mixins: [Me],
            Defaults: {
        ...
        Dt = at.extend({
            init: function(i) {
                var r = this;
                r._super(i), i = r.settings, r.canFocus = !0, i.tooltip && !1 !== Dt.tooltips && (r.on("mouseenter", function(e) {
            ...
            tooltip: function() {
                return this._tooltip || (this._tooltip = new Wt({
                    type: "tooltip"
                ...
                Z(e, function(e) {
                    ...
                    function(n) {
                        if (0 < n.length) {
                            var e = n.slice(0, 1)[0],
                                t = s(o);
                            e.moveRel(t, "tc-tc"), Z(n, function(e, t) {
    ...
    function Ft(e) {
        var t, n = _e("meta[name=viewport]")[0];
        !1 !== he.overrideViewPort && (n || ((n = _.document.createElement("meta")).setAttribute("name", "viewport"), _.document.getElementsByTagName("head")[0].appendChild(n)), (t = n.getAttribute("content")) && void 0 !== It && (It = t), n.setAttribute("content", e ? "width=device-width,initial-scale=1.0,user-scalable=0,minimum-scale=1.0,maximum-scale=1.0" : It))
    }

    function Ut(e, t) {
        (function() {
            for (var e = 0; e < zt.length; e++)
                if (zt[e]._fullscreen) return !0;
            return !1
        })() && !1 === t && _e([_.document.documentElement, _.document.body]).removeClass(e + "fullscreen")
    }
    var Vt = Ht.extend({
        modal: !0,
        Defaults: {
        ...
        init: function(e) {
            var n = this;
            n._super(e), n.isRtl() && n.classes.add("rtl"), n.classes.add("window"), n.bodyClasses.add("window-body"), n.state.set("fixed", !0), e.buttons && (n.statusbar = new yt({
                layout: "flex",
                border: "1 0 0 0",
                spacing: 3,
                padding: 10,
        ...
        fullscreen: function(e) {
            var n, t, i = this,
                ...
                o = i.classPrefix;
            if (e !== i._fullscreen)
                if (_e(_.window).on("resize", function() {
                        var e;
                        if (i._fullscreen)
                    ...
                    i._initial = {
                        ...
                        w: t.w,
                        h: t.h
                    }, i.borderBox = We("0"), i.getEl("head").style.display = "none", t.deltaH -= t.headerH + 2, _e([r, _.document.body]).addClass(o + "fullscreen"), i.classes.add("fullscreen");
                    var s = Ce.getWindowSize();
                    i.moveTo(0, 0).resizeTo(s.w, s.h)
                } else i.borderBox = We(i.settings.border), i.getEl("head").style.display = "", t.deltaH += t.headerH, _e([r, _.document.body]).removeClass(o + "fullscreen"), i.classes.remove("fullscreen"), i.moveTo(i._initial.x, i._initial.y).resizeTo(i._initial.w, i._initial.h);
            return i.reflow()
        },
        postRender: function() {
            var t, n = this;
            ...
            }, 0), n._super(), n.statusbar && n.statusbar.postRender(), n.focus(), this.dragHelper = new ht(n._id + "-dragh", {
                start: function() {
                    t = {
                        x: n.layoutRect().x,
                        y: n.layoutRect().y
        ...
        remove: function() {
            var e, t = this;
            for (t.dragHelper.destroy(), t._super(), t.statusbar && this.statusbar.remove(), Ut(t.classPrefix, !1), e = zt.length; e--;) zt[e] === t && zt.splice(e, 1);
            Ft(0 < zt.length)
        },
        ...
        if (!he.desktop) {
            ...
            u.setInterval(function() {
                ...
                n.w === e && n.h === t || (n = {
                    w: e,
                    h: t
                }, _e(_.window).trigger("resize"))
            }, 100)
        }
        _e(_.window).on("resize", function() {
            var e, t, n = Ce.getWindowSize();
            for (e = 0; e < zt.length; e++) t = zt[e].layoutRect(), zt[e].moveTo(zt[e].settings.x || Math.max(0, n.w / 2 - t.w / 2), zt[e].settings.y || Math.max(0, n.h / 2 - t.h / 2))
        })
    }();
    var Yt, $t, qt, Xt = Vt.extend({
            init: function(e) {
                e = {
                    border: 1,
                    padding: 20,
            ...
            Statics: {
                ...
                msgBox: function(e) {
                    ...
                    switch (e.buttons) {
                        case Xt.OK_CANCEL:
                            ...
                            break;
                        case Xt.YES_NO:
                        case Xt.YES_NO_CANCEL:
                            t = [n("Yes", 1, !0), n("No", 0)], e.buttons === Xt.YES_NO_CANCEL && t.push(n("Cancel", -1));
                            break;
                        default:
                            t = [n("Ok", !0, !0)]
                    }
                ...
                alert: function(e, t) {
                    return "string" == typeof e && (e = {
                        text: e
                    }), e.callback = t, Xt.msgBox(e)
                },
                confirm: function(e, t) {
                    return "string" == typeof e && (e = {
                        text: e
                    }), e.callback = t, e.buttons = Xt.OK_CANCEL, Xt.msgBox(e)
                }
            }
        }),
        jt = function(n) {
                ...
                getWindowManagerImpl: function() {
                    return {
                        ...
                        confirm: function(e, t, n) {
                            var i;
                            return (i = Xt.confirm(e, function(e) {
                                t(e)
                            })).on("close", function() {
                                n(i)
                            }), i
        ...
        Zt = Kt.extend({
            ...
            postRender: function() {
                ...
                n._super(), _e(t).on("change", function(e) {
                    var t = e.target.files;
                    n.value = function() {
                        return t.length ? n.settings.multiple ? t : t[0] : null
                    }, e.preventDefault(), t.length && n.fire("change", e)
                }), _e(t).on("click", function(e) {
                    e.stopPropagation()
                }), _e(n.getEl("button")).on("click touchstart", function(e) {
                    e.stopPropagation(), t.click(), e.preventDefault()
                }), n.getEl().appendChild(t)
            },
            remove: function() {
                _e(this.getEl("button")).off(), _e(this.getEl("input")).off(), this._super()
            }
        }),
        Qt = dt.extend({
            Defaults: {
        ...
        nn = Dt.extend({
            ...
            repaint: function() {
                ...
                var l = _.document;
                return l.all && (!l.documentMode || l.documentMode <= 8) && (t = n.layoutRect().h - 2 + "px"), _e(a).css({
                    width: e - s,
                    lineHeight: t
                }), n._super(), n
            },
            postRender: function() {
                var t = this;
                return _e(this.getEl("inp")).on("change", function(e) {
            ...
            remove: function() {
                _e(this.getEl("inp")).off(), this.menu && this.menu.remove(), this._super()
            }
        }),
        rn = nn.extend({
            init: function(e) {
            ...
            showPanel: function() {
                ...
                if (t.classes.add("opened"), t.panel) t.panel.show();
                    ...
                    n.type && (n = {
                        layout: "grid",
                        items: n
                    }), n.role = n.role || "dialog", n.popover = !0, n.autohide = !0, n.ariaRoot = !0, t.panel = new Ht(n).on("hide", function() {
        ...
        un = Dt.extend({
            ...
            postRender: function() {
                ...
                i = a.getEl("h"), r = a.getEl("hp"), o = a.getEl("sv"), s = a.getEl("svp"), a._repaint = function() {
                    c(n = l.toHsv())
                }, a._super(), a._svdraghelper = new ht(a._id + "-sv", {
                    start: e,
                    drag: e
                }), a._hdraghelper = new ht(a._id + "-h", {
                    start: t,
                    drag: t
                }), a._repaint()
            },
        ...
        bn = {
            ...
            fromPoint: function(e, t, n) {
                var i = e.dom();
                return D.from(i.elementFromPoint(t, n)).map(vn)
            }
        },
        yn = (_.Node.ATTRIBUTE_NODE, _.Node.CDATA_SECTION_NODE, _.Node.COMMENT_NODE, _.Node.DOCUMENT_NODE),
        xn = (_.Node.DOCUMENT_TYPE_NODE, _.Node.DOCUMENT_FRAGMENT_NODE, _.Node.ELEMENT_NODE),
        wn = (_.Node.TEXT_NODE, _.Node.PROCESSING_INSTRUCTION_NODE, _.Node.ENTITY_REFERENCE_NODE, _.Node.ENTITY_NODE, _.Node.NOTATION_NODE, "undefined" != typeof _.window ? _.window : Function("return this;")(), function(e, t) {
            var n = function(e, t) {
        ...
        Bn = function(e, n) {
            return An(e, n).map(function(e) {
                var t = Cn.detect(e.versionRegexes, n);
                return {
                    current: e.name,
                    version: t
                }
        ...
        Un = [{
            ...
            search: function(e) {
                return zn(e, "edge/") && zn(e, "chrome") && zn(e, "safari") && zn(e, "applewebkit")
            }
        }, {
            name: "Chrome",
            versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/, In],
            search: function(e) {
                return zn(e, "chrome") && !zn(e, "chromeframe")
            }
        }, {
            name: "IE",
            versionRegexes: [/.*?msie\ ?([0-9]+)\.([0-9]+).*/, /.*?rv:([0-9]+)\.([0-9]+).*/],
            search: function(e) {
                return zn(e, "msie") || zn(e, "trident")
            }
        }, {
            name: "Opera",
            ...
            search: function(e) {
                return (zn(e, "safari") || zn(e, "mobile/")) && zn(e, "applewebkit")
            }
        }],
        Vn = [{
            name: "Windows",
        ...
        $n = function(e) {
            var t, n, i, r, o, s, a, l, u, c, d, f = Yn.browsers(),
                h = Yn.oses(),
                m = Bn(f, e).fold(Sn.unknown, Sn.nu),
        ...
        qn = (qt = !(Yt = function() {
            ...
            return qt || (qt = !0, $t = Yt.apply(null, e)), $t
        }),
        Xn = xn,
        jn = yn,
        Jn = function(e) {
            return e.nodeType !== Xn && e.nodeType !== jn || 0 === e.childElementCount
        },
        Gn = (qn().browser.isIE(), function() {
            for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t]
        ...
        ni = function(e) {
            return e.id ? e.id : (t = "h", n = (new Date).getTime(), t + "_" + Math.floor(1e9 * Math.random()) + ++pn + String(n));
            var t, n
        },
        ii = function(e) {
            return (t = e) && "A" === t.nodeName && (t.id || t.name) && oi(e);
            var t
        },
        ri = function(e) {
        ...
        ai = function(e) {
            var t, n = ni(e);
            return ei("header", ti(e), "#" + n, ri(t = e) ? parseInt(t.nodeName.substr(1), 10) : 0, function() {
                e.id = n
            })
        },
        li = function(e) {
            var t = e.id || e.name,
                n = ti(e);
            return ei("anchor", n || "#" + t, "#" + t, 0, k)
        },
        ui = function(e) {
            var t, n, i, r, o, s;
            return t = "h1,h2,h3,h4,h5,h6,a:not([href])", n = e, K((qn().browser.isIE(), function() {
                for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t]
            }("element", "offset"), i = bn.fromDom(n), r = t, s = (o = i) === undefined ? _.document : o.dom(), Jn(s) ? [] : K(s.querySelectorAll(r), bn.fromDom)), function(e) {
                return e.dom()
            })
        },
        ci = function(e) {
            return 0 < Gn(e.title).length
        },
        di = function(e) {
            var t, n = ui(e);
            return Q((t = n, K(Q(t, si), ai)).concat(K(Q(n, ii), li)), ci)
        },
        fi = {},
        hi = function(e) {
            return {
        ...
        pi = function(e, i, r, t) {
            var n, o, s, a, l, u, c = {
                ...
                f = function(t) {
                    var e, n = Q(i, function(e) {
                        return e.type === t
                    });
                    return e = n, w.map(e, hi)
                };
            return !1 === t.typeahead_urls ? [] : "file" === r ? (n = [bi(e, d(fi)), bi(e, f("header")), bi(e, (a = f("anchor"), l = gi(t, "anchor_top", "#top"), u = gi(t, "anchor_bottom", "#bottom"), null !== l && a.unshift(mi("<top>", l)), null !== u && a.push(mi("<bottom>", u)), a))], o = function(e, t) {
        ...
        vi = function(e, t) {
            var n, i, r, o = fi[t];
            /^https?/.test(e) && (o ? (n = o, i = e, r = J(n, i), -1 === r ? D.none() : D.some(r)).isNone() && (fi[t] = o.slice(0, 5).concat(e)) : fi[t] = [e])
        },
        bi = function(e, t) {
            var n = e.toLowerCase(),
            ...
            init: function(e) {
                ...
                e.spellcheck = !1, (i = d.file_picker_types || d.file_browser_callback_types) && (i = w.makeMap(i, /[, ]/)), i && !i[f] || (!(n = d.file_picker_callback) || i && !i[f] ? !(n = d.file_browser_callback) || i && !i[f] || (t = function() {
                    ...
                    r.getRoot().on("submit", function(e) {
                        e.isDefaultPrevented() || vi(r.value(), a)
                    })
                }), yi(u, d, f)
            }
        }),
        ...
        _i = Gt.extend({
            recalc: function(e) {
                var t, n, i, r, o, s, a, l, u, c, d, f, h, m, g, p, v, b, y, x, w, _, R, C, E, k, H, S, T, M, N, P, W, D, O, A, B, L = [],
                    z = Math.max,
                    I = Math.min;
                ...
                if ((y = {})[R] = d < 0 ? r[R] - d + r[S] : r[H] - d + r[S], y[W] = w + r[A], y[T] = r[H] - d, y[B] = w, y.minW = I(y.minW, r.maxW), y.minH = I(y.minH, r.maxH), y.minW = z(y.minW, r.startMinWidth), y.minH = z(y.minH, r.startMinHeight), !r.autoResize || y.minW === r.minW && y.minH === r.minH) {
                    ...
                    for (b = d / c, x = o[k], y = {}, 0 === c && ("end" === l ? x = d + o[k] : "center" === l ? (x = Math.round(r[H] / 2 - (r[H] - d) / 2) + o[k]) < 0 && (x = o[k]) : "justify" === l && (x = o[k], u = Math.floor(d / (i.length - 1)))), y[M] = o[D], t = 0, n = i.length; t < n; t++) p = (m = (h = i[t]).layoutRect()).maxFlexSize || m[R], "center" === a ? y[M] = Math.round(r[N] / 2 - m[P] / 2) : "stretch" === a ? (y[P] = z(m[W] || 0, r[N] - o[D] - o[O]), y[M] = o[D]) : "end" === a && (y[M] = r[N] - m[P] - o.top), 0 < m.flex && (p += m.flex * b), y[_] = p, y[C] = x, h.layoutRect(y), h.recalc && h.recalc(), x += p + u
        ...
        Ci = function(e, t) {
            return n = t, r = (i = e) === undefined ? _.document : i.dom(), Jn(r) ? D.none() : D.from(r.querySelector(n)).map(bn.fromDom);
            var n, i, r
        },
        Ei = function(e, t) {
            return function() {
        ...
        Si = function(i) {
            var t = ["alignleft", "aligncenter", "alignright", "alignjustify"],
                ...
                e = [{
                    text: "Left",
                    icon: "alignleft",
                    onclick: Ei(i, "alignleft")
                }, {
                    text: "Center",
                    icon: "aligncenter",
                    onclick: Ei(i, "aligncenter")
                }, {
                    text: "Right",
                    icon: "alignright",
                    onclick: Ei(i, "alignright")
                }, {
                    text: "Justify",
                    icon: "alignjustify",
                    onclick: Ei(i, "alignjustify")
                }];
            i.addMenuItem("align", {
                text: "Align",
                menu: e
                ...
                a.state.set("value", null), l.on("init nodeChange", function(e) {
                    var t, n, i, r, o = l.queryCommandValue("FontName"),
                        s = (t = u, r = (n = o) ? n.toLowerCase() : "", w.each(t, function(e) {
                            ...
                            i || Ti(e.value).toLowerCase() !== Ti(r).toLowerCase() || (i = e.value)
                        }), i);
                    a.value(s || null), !s && o && a.text(Ti(o))
                })
            }
        },
        Ni = function(n) {
                    ...
                    onPostRender: (s = n, a = t, function() {
                        ...
                        s.on("init nodeChange", function(e) {
                            ...
                            if (t = s.queryCommandValue("FontSize"))
                                for (i = 3; !r && 0 <= i; i--) n = Wi(t, i), r = Di(a, n, t);
        ...
        Li = function(n, e) {
            ...
            return e.items().each(function(e) {
                e.menu && e.visible(0 < Li(n, e.menu)), !e.menu && e.settings.menu && e.visible(0 < Bi(n, e.settings.menu));
        ...
        zi = function(e) {
            var i, r, o, t, s, n, a, l, u = (r = 0, o = [], t = [{
                ...
                itemDefaults: {
                    ...
                    onclick: function() {
                        this.settings.format && Ei(i, this.settings.format)(), this.settings.cmd && i.execCommand(this.settings.cmd)
                    }
                }
            });
            n = u, e.addMenuItem("formats", {
                ...
                menu: l,
                onShowMenu: function() {
                    a.settings.style_formats_autohide && Li(a, this.menu)
                }
            })
        },
        Ii = function(n, e) {
        ...
        Fi = function(e) {
            ...
            }), e.addButton("formatselect", Ii(e, i))
        },
        Ui = function(t, e) {
            var n, i;
            if ("string" == typeof e) i = e.split(" ");
                ...
                for (var t = [], n = 0, i = e.length; n < i; ++n) {
                    if (!q(e[n])) throw new Error("Arr.flatten item " + n + " was not an array, input: " + e);
                    ne.apply(t, e[n])
                }
                return t
            }(w.map(e, function(e) {
        ...
        Yi = function(e) {
            var t = Q(e, function(e, t, n) {
                return !Vi(e) || !Vi(n[t - 1])
            });
            return Q(t, function(e, t, n) {
                return !Vi(e) || 0 < t && t < n.length - 1
            })
        },
        $i = function(e) {
            var t, n, i, r, o = e.settings.insert_button_items;
            return Yi(o ? Ui(e, o) : (t = e, n = "insert", i = [{
                text: "-"
        ...
        qi = function(e) {
            ...
            (t = e).addButton("insert", {
                ...
                oncreatemenu: function() {
                    this.menu.add($i(t)), this.menu.renderNew()
                }
            })
        },
        Xi = function(e) {
        ...
        Zi = {
            setup: function(e) {
                var t;
                e.rtl && (at.rtl = !0), e.on("mousedown progressstate", function() {
                    Ht.hideAll()
                }), (t = e).settings.ui_container && (he.container = Ci(bn.fromDom(_.document.body), t.settings.ui_container).fold(H(null), function(e) {
                    return e.dom()
                })), Dt.tooltips = !he.iOS, at.translate = function(e) {
                    return h.translate(e)
                }, Fi(e), Si(e), ji(e), Gi(e), Ai(e), Pi(e), zi(e), Ki(e), qi(e)
            }
        },
        Qi = Gt.extend({
            recalc: function(e) {
                var t, n, i, r, o, s, a, l, u, c, d, f, h, m, g, p, v, b, y, x, w, _, R, C, E, k, H, S, T = [],
                    M = [];
                ...
                for (f = 0; f < n; f++)
                    for (d = 0; d < i && (c = r[f * i + d]); d++) C = (u = c.layoutRect()).minW, E = u.minH, T[d] = C > T[d] ? C : T[d], M[f] = E > M[f] ? E : M[f];
        ...
        or = Kt.extend({
            ...
            postRender: function() {
                ...
                return r.on("click", function(e) {
                    ...
                    var t, n = e.control,
                        i = r.parent();
                    n && i && n instanceof or && n.parent() === i && (i.items().filter("MenuButton").each(function(e) {
        ...
        sr = Ht.extend({
            ...
            init: function(e) {
                ...
                this._super(e), this.classes.add("menu"), e.animate && 11 !== he.ie && this.classes.add("animate")
            },
            repaint: function() {
        ...
        ar = or.extend({
            ...
            bindStates: function() {
                ...
                return i.on("show", function(e) {
                    var t, n;
                    t = e.control, n = i.value(), t instanceof sr && t.items().each(function(e) {
        ...
        cr = Dt.extend({
            ...
            postRender: function() {
                var t = this;
                t._super(), t.resizeDragHelper = new ht(this._id, {
                    start: function() {
                        t.fire("ResizeStart")
                    },
                    drag: function(e) {
    ...
    var fr = Dt.extend({
        ...
        renderHtml: function() {
            var e, t = this,
                n = "";
            return e = dr(t._options), t.size && (n = ' size = "' + t.size + '"'), '<select id="' + t._id + '" class="' + t.classes + '"' + n + ">" + e + "</select>"
        },
        bindStates: function() {
            var t = this;
            return t.state.on("change:options", function(e) {
                t.getEl().innerHTML = dr(e.value)
            }), t._super()
        }
    });
    ...
    var pr = Dt.extend({
            init: function(e) {
                ...
                }), t._super(e), t.classes.add("slider"), "v" === e.orientation && t.classes.add("vertical"), t._minValue = j(e.minValue) ? e.minValue : 0, t._maxValue = j(e.maxValue) ? e.maxValue : 100, t._initValue = t.state.get("value")
            },
            renderHtml: function() {
                var e = this._id,
                    t = this.classPrefix;
            ...
            postRender: function() {
                ...
                e = m._minValue, t = m._maxValue, "v" === m.settings.orientation ? (n = "screenY", i = "top", r = "height", o = "h") : (n = "screenX", i = "left", r = "width", o = "w"), m._super(),
                    function(o, s) {
                        function t(e) {
                            var t, n, i, r;
                            t = hr(t = (((t = m.value()) + (r = n = o)) / ((i = s) - r) + .05 * e) * (i - n) - n, o, s), m.value(t), m.fire("dragstart", {
                                value: t
                            }), m.fire("drag", {
                                value: t
                            }), m.fire("dragend", {
                    ...
                    }(e, t), s = e, a = t, l = m.getEl("handle"), m._dragHelper = new ht(m._id, {
                        handle: m._id + "-handle",
                        start: function(e) {
                        ...
                        drag: function(e) {
                            var t = e[n] - u;
                            f = hr(c + t, 0, d), l.style[i] = f + "px", h = s + f / d * (a - s), m.value(h), m.tooltip().text("" + m.settings.previewFilter(h)).show().moveRel(l, "bc tc"), m.fire("drag", {
                                value: h
                            })
                        },
                        stop: function() {
        ...
        br = or.extend({
            ...
            repaint: function() {
                var e, t, n = this.getEl(),
                    i = this.layoutRect();
                return this._super(), e = n.firstChild, t = n.lastChild, _e(e).css({
            ...
            activeMenu: function(e) {
                _e(this.getEl().lastChild).toggleClass(this.classPrefix + "active", e)
            },
            renderHtml: function() {
                var e, t, n = this,
                    i = n._id,
        ...
        Rr = function(n) {
            n.ui ? w.each(_r(), function(e, t) {
                n.ui[t] = e
            }) : n.ui = _r()
        };
    w.each(_r(), function(e, t) {
        b.add(t, e)
    }), Rr(window.tinymce ? window.tinymce : {}), o.add("modern", function(e) {
        return Zi.setup(e), jt(e)
    })
}(window);