...
namespace E_ProjectSem3.Controllers
{
    public class IngredientsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IngredientId,Name,RecipeId,Amout,Note,CreatedAt,UpdatedAt,DeletedAt")] Ingredient ingredient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IngredientId,Name,RecipeId,Amout,Note,CreatedAt,UpdatedAt,DeletedAt")] Ingredient ingredient)
        {
            if (ModelState.IsValid)
            {
